        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
          ...
          {COLUMNS.map((column) => (
            <nav key={column.title} aria-label={column.title}>
              <h3 className="text-xs font-bold uppercase tracking-[0.16em] text-ink">{column.title}</h3>
          ...
          <div>
            <h3 className="text-xs font-bold uppercase tracking-[0.16em] text-ink">Get started</h3>
        ...
        <div className="mt-12 flex flex-col gap-2 border-t border-line pt-6 text-xs text-muted">
          ...
          <div className="flex flex-col items-center justify-between gap-4 pt-4 sm:flex-row">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href={SITE.twitter} target="_blank" rel="noreferrer" className="transition hover:text-ink" aria-label="X">
                <Twitter className="h-4 w-4" aria-hidden="true" />
              </a>
              <a href={SITE.github} target="_blank" rel="noreferrer" className="transition hover:text-ink" aria-label="LinkedIn">
